...
import razorpay
from student.decerators import signin_required
...
class OrderCheckoutView(View):
    def get(self,request,*args,**kwargs):
        ...
        if order_total>0:
            ...
            order_instance.rzp_order_id=id=rzp_id
            order_instance.save()
...
class LessonDetailView(View):
    def get(self,request,*args,**kwargs):
        ...
        purchased_courses = request.user.purchase.filter(is_paid=True).values_list("course_objects",flate=True)
...
class PaymentVerificationView(View):
    def post(self,request,*args,**kwargs):
        ...
        try:
            ...
            rzp_order = POST.get("razorpay_order_id")
